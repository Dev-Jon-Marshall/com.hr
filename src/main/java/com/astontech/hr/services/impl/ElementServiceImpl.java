...
public class ElementServiceImpl implements ElementService
{
    ...
    @Override
    public List<Element> findAllByElementNameContainingAllIgnoreCase(String contains)
    {
        return elementRepository.findAllByElementNameContainingAllIgnoreCase(contains);
    }

    @Override
    public List<Element> findAllByElementNameStartingWith(String startsWith)
    {
        return elementRepository.findAllByElementNameStartingWith(startsWith);
    }
}
